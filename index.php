<?php
// Shows the first 15 joblistings
if(!$_POST){
    $_POST['showAmount'] = 15;
}
...
<div class="container-fluid border border ml-1 mr-1">
     <div class="row">
       <div class="col-md-3" style="background: rgb(249,246,242);min-height: 300px;" id="searchFormDiv">
         ...
         <div class="col-md-9 pl-1 pr-1" id="jobListings" tabindex="0" style="overflow: scroll;">
           <table class="table table-striped">
             <thead>
               <tr>
                 <th class='text-white' style="background: rgb(66,139,202)">Avoimet työpaikat
                     <span class="badge badge-light ml-2"><?php getJoblistingAmount(0) ?></span></th>
               </tr>
             </thead>
               <tbody id="tableBody">
                 <?php
                     require_once('includes/allJobs.php');
                  ?>
               </tbody>
            </table>
