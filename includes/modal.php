        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group" id="categoriesForm">
                    ...
                    <div class="form-check text-black">
                        <input type="checkbox" value="Terveyden- ja sairaanhoito" id="terveydenhuolto" name="terveydenhuolto" class="form-check-input"  form="searchForm" <?php if(isset($_POST['terveydenhuolto'])) echo "checked='checked'"; ?>  />
                    ...
                    <div class="form-check text-black">
                        <input type="checkbox" value="Sosiaaliala" id="sosiaalityo" name="sosiaalityo" class="form-check-input"  form="searchForm" <?php if(isset($_POST['sosiaalityo'])) echo "checked='checked'"; ?>  />
                    ...
                    <div class="form-check text-black">
                        <input type="checkbox" id="hallinto" value="Hallinto-, esimies- ja asiantuntijatyö" name="hallinto" class="form-check-input" form="searchForm" <?php if(isset($_POST['hallinto'])) echo "checked='checked'"; ?>>
